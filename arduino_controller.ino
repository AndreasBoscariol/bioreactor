...
// R1 = heater, R2 = stir, R3 = lights, R4 = aerator
...
const uint8_t IR_LED_PIN = A2;    // moved off 10 so it no longer conflicts with RELAY_HEATER

const uint8_t PHOTO1_PIN = A0;
const uint8_t PHOTO2_PIN = A1;

/* ---- thermocouples on SPI ---- */
// (these were originally on 11/12; if you need to avoid conflicts
// you can move them to any other free digital pins, e.g. 8 & 9)
...
void setup() {
  ...
  // start all relays OFF (HIGH), IR OFF, pumps OFF
